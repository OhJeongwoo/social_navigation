...
#include "social_navigation/RRT_service.h"
...
bool service_rrt(social_navigation::RRT_service::Request  &req,
                 social_navigation::RRT_service::Response &res)
{
...
int main(int argc,char** argv){
  ...
  ros::NodeHandle nh;
  ros::ServiceServer service = nh.advertiseService("rrt", service_rrt);
