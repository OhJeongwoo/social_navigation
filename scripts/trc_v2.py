...
from gazebo_master_old_v2 import PedSim
import wandb
...
wandb.run.name = 'trc_medium_ped_7.5m'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--yaml', default='trc', type=str)
    ...
    for t in range(total_steps):
        ...
        #     torch.save(ac_, POLICY_PATH + exp_name_ + "/trc_hard_ped" + str(epoch).zfill(3)+".pt")
