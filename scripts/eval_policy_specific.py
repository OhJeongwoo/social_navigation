...
import torch.nn
from utils import *
from gazebo_master_specific import PedSim
...
if __name__ == "__main__":
    ...
    parser.add_argument('--n_episode', default=20, type=int)
    parser.add_argument('--scenario_num', default=6, type=int)
    ...
    init_time = time.time()
    # exp_name = "SAN-MCTS_TRC_SPECIFIC_1"
    exp_name = "test"
    print(exp_name)
    save_dict = {}
    epi_info = []
