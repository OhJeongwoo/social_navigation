...
wandb.run.name = 'sac_medium_ped_testingonly'
...
if __name__ == "__main__":
    ...
    ac_weights = torch.load(POLICY_PATH + exp_name_ + "/sac_172.pt")
    ...
    for t in range(total_steps):
        ...
        #     torch.save(ac_, POLICY_PATH + exp_name_ + "/sac_ped_" + str(epoch).zfill(3)+".pt")
