...
#include "social_navigation/Command.h"
#include "social_navigation/Status.h"
...
namespace gazebo
{
  ...
  class HumanPlugin : public ModelPlugin
  {
    /// \brief Constructor.
    public: HumanPlugin();

    /// \brief Destructor.
    public: virtual ~HumanPlugin();
    ...
    private: void CallbackCmd(const social_navigation::Command::ConstPtr &msg);
    ...
    /// \brief Private data
    private: std::unique_ptr<HumanPluginPrivate> dataPtr;
